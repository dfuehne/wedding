...
export default function ProposalPage() {
  const pins: CluePin[] = [
    { id: 'bp', x: 58.0, y: 10.0, label: 'Before You Play', link: '/proposalClues/before-you-play', zoom: 1.0, tx: 58.0, ty:20.0},
    { id: 'i', x: 58.0, y: 23.0, label: 'Introduction', link: '/proposalClues/introduction', zoom: 1.5, tx:33.33, ty:23.0},
    { id: '1', x: 55.8, y: 35.8, label: 'Clue 1', link: '/proposalClues/clue-1', zoom: 1.5, tx: 33.33, ty:33.33},
    { id: '2', x: 51.9, y: 45.8, label: 'Clue 2', link: '/proposalClues/clue-2', zoom: 1.5, tx: 33.33, ty:33.33},
    { id: '3', x: 61.0, y: 38.4, label: 'Clue 3', link: '/proposalClues/clue-3', zoom: 1.5, tx: 33.33, ty:33.33},
    { id: '4', x: 67.4, y: 85.9, label: 'Clue 4', link: '/proposalClues/clue-4', zoom: 1.4, tx: 33.33, ty:63.33},
    { id: '5', x: 60.5, y: 96.2, label: 'Clue 5', link: '/proposalClues/clue-5', zoom: 1.5, tx: 33.33, ty:33.33},
    { id: '6', x: 66.1, y: 82.9, label: 'Clue 6', link: '/proposalClues/clue-6', zoom: 1.5, tx: 33.33, ty:33.33},
    { id: '7', x: 65.1, y: 81.0, label: 'Clue 7: Proposal', link: '/proposalClues/clue-7', zoom: 5, tx: 9, ty:3},
  ];
